...
path, sim = metrics.dtw_path(s_y1, s_y1)
path2, sim2 = metrics.dtw_path(s_y1, np.roll(s_y1, 2))
a=metrics.dtw(s_y1, s_y1)
d, cost_matrix, acc_cost_matrix, path = dtw(s_y1, s_y1, dist=manhattan_distance)
